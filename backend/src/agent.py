...
CATALOG_FILE = os.path.abspath(os.path.join(SCRIPT_DIR, "..", "shared-data", "grocery_catalog.json"))
ORDERS_FILE = os.path.abspath(os.path.join(SCRIPT_DIR, "..", "shared-data", "orders.json"))
